    ...
    $.AdminLTE.layout = {
        activate: function () {
            ...
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                ($(".content-wrapper, .right-side").css("min-height", c), d = c); var e = $($.AdminLTE.options.controlSidebarOptions.selector);
        ...
        activate: function (a) {
            var b = $.AdminLTE.options.screenSizes; $(a).on("click", function (a) {
                //man
                $("#navi").addClass("navbarcol");
                //$("#navi").removeClass("navbarcol");
                a.preventDefault(), $(window).width() > b.sm - 1 ?
            ...
            $(".main-sidebar").hover(function ()
            {
                $("body").hasClass("sidebar-mini") &&
                  $("body").hasClass("sidebar-collapse") && $(window).width() > b && a.expand()
            },
            function () {
                $("body").hasClass("sidebar-mini") && $("body").hasClass("sidebar-expanded-on-hover") &&
        ...
        $("li a", $(a)).on("click", function (a) {
            ...
            if (d.is(".treeview-menu") && d.is(":visible"))
                d.slideUp("normal",
                    function () { d.removeClass("menu-open") }),
                    d.parent("li").removeClass("active");
            else if (d.is(".treeview-menu") && !d.is(":visible")) {
                var e = c.parents("ul").first(),
                    f = e.find("ul:visible").slideUp("normal"); f.removeClass("menu-open");
                var g = c.parent("li"); d.slideDown("normal", function () {
                    d.addClass("menu-open"),
                        e.find("li.active").removeClass("active"), g.addClass("active"), b.layout.fix()
                })
        ...
        activate: function () {
            var a = this,
                ...
                c = $(b.selector), d = $(b.toggleBtnSelector);
        ...
        open: function (a, b) {
            var c = this; b ? (a.addClass("control-sidebar-open"), $(".content-wrapper, .right-side").on("click", function () { c.close(a, b) })) : $("body").addClass("control-sidebar-open")
        },
        close: function (a, b) {
...
$.AdminLTE = {}, $.AdminLTE.options =
    {
        ...
        sidebarToggleSelector: "[data-toggle='offcanvas']", sidebarPushMenu: !0,
        sidebarSlimScroll: !0, sidebarExpandOnHover: !1, enableBoxRefresh: !0, enableBSToppltip: !0,
        BSTooltipSelector: "[data-toggle='tooltip']", enableFastclick: !0, enableControlSidebar: !0,
        controlSidebarOptions: {
            toggleBtnSelector: "[data-toggle='control-sidebar']", selector: ".control-sidebar",
            slide: !0
